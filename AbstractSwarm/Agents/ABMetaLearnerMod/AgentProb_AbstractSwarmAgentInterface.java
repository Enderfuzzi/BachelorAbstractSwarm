 ...
 * .outgoing       whether the edge is outgoing<br />
 */
public class AgentProb_AbstractSwarmAgentInterface 
{
	...
	static double probAttribute = 0.5;
	static double probSpace = 0.16;
	static double probDistance = 0.16;
	static double probFreqNec = 0.16;
