...
public class AbstractSwarmAgentInterface 
{
	...
	{
		return SmartAgent.evaluate(me, others, stations, time, station);
	}
	...
	{
		return SmartAgent.communicate(me, others, stations, time, defaultData);
	}
	...
	{
		SmartAgent.reward(me, others, stations, time, value);
	}
}